...
#nullable enable
        ...
        protected virtual async Task DeleteAsync()
        {
            ...
            try
            {
                ...
                await JSRuntime.ShowToastAsync(ToastType.success, @Localizer["ITEM"] + " " + @Localizer["DELETED"]);
            ...
            catch (Exception ex)
            {
                ...
                {
                    await JSRuntime.ShowToastAsync(ToastType.error, @Localizer["ERROR"]);
                }
                else
                {
                    throw;
        ...
        protected virtual async Task SaveAsync()
        {
            ...
            if (_form.EditContext.Validate())
            {
                ...
                await JSRuntime.ShowToastAsync(ToastType.success, @Localizer["ITEM"] + " " + @Localizer["SAVED"]);
